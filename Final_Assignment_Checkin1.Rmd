...
ggplot(final_data, aes(x = Expression)) + 
  geom_histogram(fill = "pink", color = "red") + # plots the histogram with bars outlined and filled
...
ggplot(final_data,aes(x = Age,y = Gene ,color = pink)) + # The + is how we communicate to ggplot2 that we aren't done adding elements to the plot
